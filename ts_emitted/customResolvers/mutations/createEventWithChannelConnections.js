...
var getResolver = function (_a) {
    ...
    return function (parent, args, context, info) { return __awaiter(void 0, void 0, void 0, function () {
        var eventCreateInput, channelConnections, selectionSet, response, newEvent, newEventId, session, i, channelUniqueName, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    eventCreateInput = args.eventCreateInput, channelConnections = args.channelConnections;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Event.create({
                            ...
                            selectionSet: "{ events ".concat(selectionSet, " }")
                        })];
                case 2:
                    response = _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, session.run(createEventChannelQuery, {
                            eventId: newEventId,
                ...
                case 5:
                    i++;
                    return [3 /*break*/, 3];
                case 6: return [4 /*yield*/, Event.find({
                        where: {
                            id: newEventId,
                        },
                ...
                case 8:
                    ...
                    throw new Error("Failed to create event. ".concat(error_1.message));
