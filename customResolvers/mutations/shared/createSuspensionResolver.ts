...
export function createSuspensionResolver({
  ...
  return async function suspendEntityResolver(
    ...
    // 1. Fetch Issue to ensure it exists and to retrieve the channel unique name.
    ...
    // 2. Make sure the user is logged in and is a moderator
    ...
    // 3. Build the ModerationAction creation input
    ...
    // 5. Update the Channel's suspended field (e.g. SuspendedUsers / SuspendedMods)
